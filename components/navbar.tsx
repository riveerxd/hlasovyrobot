...
export function Navbar() {
  ...
  const handleContactClick = () => {
    window.location.href = "tel:+420777325590";
  };
          ...
          <div className="hidden md:flex items-center gap-8">
            {menuItems.map((item) => (
              <Link
                ...
                duration={500}
                offset={-100}
                className="text-sm font-medium text-muted-foreground hover:text-primary cursor-pointer transition-colors relative group font-sans"
              >
                {item.label}
            ...
            <Button 
              ...
              className="gap-2 group font-heading"
            >
        ...
        <div className="container max-w-5xl mx-auto px-4 py-4 flex flex-col gap-4">
          {menuItems.map((item) => (
            <Link
              ...
              duration={500}
              offset={-100}
              className="text-sm font-medium text-muted-foreground hover:text-primary cursor-pointer transition-colors px-2 py-1.5 rounded-lg hover:bg-accent font-sans"
          ...
          <Button 
            className="gap-2 group w-full font-heading"
            onClick={() => {
              handleContactClick();
              setIsMenuOpen(false);
            }}
